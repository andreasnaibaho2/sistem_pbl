...
<head>
    ...
    <title>Akses Ditolak — PBL Portal</title>
...
<body class="min-h-screen bg-[#f4f7f6] font-sans flex items-center justify-center p-6">
    <div class="text-center max-w-md">
        ...
        <h1 class="text-6xl font-black italic text-[#004d4d] tracking-tighter mb-2">403</h1>
        <h2 class="text-xl font-black text-gray-700 uppercase tracking-tight mb-3">
            Akses <span class="text-red-500">Ditolak</span>
        </h2>
