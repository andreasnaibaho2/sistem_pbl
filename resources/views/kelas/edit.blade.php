...
<div class="max-w-xl">
    <div class="flex items-center gap-3 mb-8">
        ...
        <div>
            <h1 class="text-2xl font-bold text-on-surface">Edit Kelas</h1>
            <p class="text-sm text-on-surface-variant mt-0.5">Perbarui data kelas</p>
        </div>
    </div>
        ...
        <form action="{{ route('kelas.update', $kelas->id) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <select name="matkul_id"
                    ...
                    <option value="{{ $mk->id }}" {{ old('matkul_id', $kelas->matkul_id) == $mk->id ? 'selected' : '' }}>
                        {{ $mk->nama_matkul }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <input type="text" name="tahun_akademik" value="{{ old('tahun_akademik', $kelas->tahun_akademik) }}"
